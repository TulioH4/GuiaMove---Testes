...
app.config["SECRET_KEY"] = "seemove-kinect-secret"
...
def set_voice_settings():
    ...
    if v.enabled and ("rate" in data or "volume" in data or "voice_id" in data):
        _tts.speak("Configuração de voz atualizada.")
