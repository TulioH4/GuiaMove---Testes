...
class KinectSettings:
    ...
    # beta maior = filtro abre mais rápido em movimento (menos atraso no
    # boneco); min_cutoff controla o tremor parado. Calibrado em gravações
    # reais com o detector em modo VIDEO (menos ruído de entrada que o modo
    # IMAGE): 2.0/1.5 dá ~17 ms de atraso (era ~50 ms com 1.2/1.5) e jitter
    # residual ainda menor que o de antes.
