...
class KinectTracker:
    ...
    def __init__(self,
        ...
        self.use_depth           = use_depth and (_FREENECT_OK or (use_sdk_bridge and use_sdk_depth))
    ...
    def _loop(self):
        ...
        if self.use_sdk_bridge:
            ...
            bridge = KinectSDKBridge(log=lambda m: self._log(m, False))
            if not bridge.start():
                self._running = False
